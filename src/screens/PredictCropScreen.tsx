...
interface PrediccionesScreenProps {
  navigation?: any
}
...
export default function PrediccionesScreen({ navigation }: PrediccionesScreenProps = {}) {
  ...
  const handleModeloMachineLearning = () => {
    navigation?.navigate("PrediccionML")
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.subHeader]}>
        ...
        <MaterialIcons name="psychology" size={26} color={isDark ? "#34D399" : "#007b3e"} />
      </View>
        ...
        <View style={styles.modelsContainer}>
          ...
          >
            ...
            <View style={styles.modelContent}>
              <Text style={styles.modelTitle}>{t("modeloregresionunificada")}</Text>
              <Text style={styles.modelDescription}>
                {t("textomodeloderegresionunificada")}
              </Text>
              <View style={styles.modelFeatures}>
                <FeatureItem iconColor="#059669" text={t("Predicciónaltura")} isDark={isDark} />
                <FeatureItem iconColor="#059669" text={t("Predicciónareafoliar")} isDark={isDark} />
              </View>
            </View>
